	...
	function get_settings() {
		$settings = array(
			...
			array(
				...
				'link'      => '<a class="button-primary" href="' . wp_nonce_url( add_query_arg( 'alg_woocommerce_checkout_fees_delete_all_data', '1' ),
						'alg_woocommerce_checkout_fees_delete_all_data', 'alg_woocommerce_checkout_fees_delete_all_data_nonce' ) . '"' .
