	...
	function get_settings() {
		$settings = array(
			array(
				...
				'type'      => 'title',
				'desc'      =>
					sprintf( __( 'Values that will be replaced in templates below are: %s.', 'checkout-fees-for-woocommerce' ),
					...
					sprintf( __( 'You can also use %s and %s shortcodes. Or %s and %s functions.', 'checkout-fees-for-woocommerce' ),
